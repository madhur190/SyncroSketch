            ...
            <form onSubmit={handleSignup}>
                <div className="bg-white w-[40rem] p-4 rounded-xl shadow min-h-96 mt-5 flex flex-col items-center justify-evenly">
                    <div className="w-full max-w-[30rem]">
                        <InputBox reference={nameRef} type="text" heading="Name" placeholder="Joe"/>
                    </div>
                    <div className="w-full max-w-[30rem]">
                    ...
                    <div className="">
                        <Button loading={loading} submit={true} type="primary" size="lg" text="Sign Up"/>
                    </div>
                    <div className="flex">
                        ...
                        <div>
                            <Link className="text-blue-700" href={"/signin"}>Log in</Link>
                        </div>
                    </div>
                </div>
            </form>
